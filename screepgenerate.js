var ScreepGenerate = {
    run:function()
    {
        ...
        var numUpgrader = 6         ; var numUpgrader1 = 0           ;
        var numBuilder = 3          ; var numBuilder1 = 0           ;
        var numRepairer = 1         ; var numRepairer1 = 2         ; 
        var numWallBuilder = 4      ;
        var numTransferer = 3       ; var numOutHarvester1 = 0      ; var numReserver = 0           ;
        var numfighter0 = 0         ; var numOutHarvester2 = 0      ; var numCarrier = 1            ;
        ...
        if(Game.rooms['W53N8'].energyAvailable>=limit)
        {
            ...
            if(builders.length < numBuilder) {
                ...
                Game.spawns['Home1'].spawnCreep([WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,CARRY,CARRY,MOVE,MOVE], newName, {memory: {role: 'builder'}});        
            }
            ...
            if(wallbuilder.length < numWallBuilder) {
                ...
                Game.spawns['Home1'].spawnCreep([WORK,WORK,WORK,WORK,WORK,CARRY,CARRY,CARRY,MOVE,MOVE,MOVE,MOVE,CARRY,CARRY,MOVE,MOVE], newName, {memory: {role: 'wallbuilder'}});        
            }
            /**
             *   外矿Creep
             */
